#!/bin/bash
#SBATCH --job-name=tracking_fused    # Name of your job
#SBATCH --time=48:00:00           # Max runtime (Hours:Minutes:Seconds)
#SBATCH --ntasks=1                 # Number of tasks
#SBATCH --cpus-per-task=8        # Number of CPU cores
#SBATCH --mem-per-cpu=12G         # Request 12GB of RAM per CPU
#SBATCH --gpus=rtx_4090:1         # Request 1 GPU
#SBATCH --output=tracking_fused_%j.log
#SBATCH --error=tracking_fused_%j.err 
#SBATCH --tmp=50G                
...
python train.py train 120_hrnet32_fused